...
export default function SelectSkills({setUnprofessionalSkill,unprofessionalSkill}) {
    ...
    const handleSubmit=()=>{
      history.push("/professionalSkills",{unprofessionalSkills:selectedSkills})
          // <Redirect to="/professionalSkills"/>
    }
    return (
        <Box
            sx={{
